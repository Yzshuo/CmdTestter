...
//    }
    ...
    {
//        SetTexditData(tr("模块")+ui->Cbx_modu->currentText()+tr("开始采集荧光,当前采集第")+QString::number(fluo_check+1)+"/"+QString::number(number) +tr("次"));
        SetTexditData(tr("开始采集荧光,当前采集第")+QString::number(fluo_check+1)+"/"+QString::number(number) +tr("次"));
...
//    SetTexditData(tr("设置")+ui->Cbx_modu->currentText()+tr("模块电机位置：")+ui->Led_eles_set_point->text());
     SetTexditData(tr("设置电机位置：")+ui->Led_eles_set_point->text());
